...
export default function Container({children, header, headerIcon}: Props) {
  return (
    <>
        ...
        <div className={`min-w-full max-w-full w-full ${jetbrains.className} h-[88vh] rounded-b-md px-5 xs:px-15 py-5  bg-wk-bg text-wk-text overflow-y-hidden overflow-x-hidden `}>
